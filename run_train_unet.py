...
def parse_args_from_list(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--num-conditions", type=int, default=1)
    parser.add_argument("--condition-axes", nargs="+", choices=["x", "y", "z"], default=None)
    parser.add_argument("--condition-slice-indices", nargs="+", type=int, default=None)
