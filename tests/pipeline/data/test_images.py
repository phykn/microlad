...
class ImageLoaderTest(unittest.TestCase):
    def test_load_gray_image_returns_uint8_hw_array(self):
    ...
    def test_load_gray_image_scales_uint16_tiff_to_uint8(self):
        with tempfile.TemporaryDirectory() as tmp:
    ...
    def test_load_gray_image_scales_normalized_float_to_uint8(self):
        with tempfile.TemporaryDirectory() as tmp:
    ...
    def test_load_gray_image_rejects_non_finite_values(self):
        cases = [
    ...
    def test_load_gray_image_rounds_near_integer_float_values(self):
        with tempfile.TemporaryDirectory() as tmp:
    ...
    def test_load_gray_image_preserves_low_uint16_values(self):
        with tempfile.TemporaryDirectory() as tmp:
    ...
    def test_load_gray_image_converts_palette_to_grayscale(self):
        with tempfile.TemporaryDirectory() as tmp:
