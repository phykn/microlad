...
from src.pipeline.predict.guidance.conditioning.images import prepare_phase_image
...
from src.pipeline.predict.guidance.metrics.fraction import compute_phase_fraction
from src.pipeline.predict.guidance.metrics.interface import compute_interface_density
...
def _validate_options(
    *,
    ...
    if use_diffusivity and low_phase_conductivity == 0.0:
        raise ValueError(
            "low_phase_conductivity must be positive when diffusivity is enabled."
        )
